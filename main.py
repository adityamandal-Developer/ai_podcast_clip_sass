...
def process_clip(
    ...
    s3_client.upload_file(subtitle_output_path, "ai-podcast-clipper-new", output_s3_key)
...
@app.cls(
    ...
    retries=0,
    scaledown_window=20,
    secrets=[modal.Secret.from_name("ai-podcast-clip-sass")],
...
def main():
    ...
    payload = {"s3_key": "test1/lawr5min.mp4"}

    headers = {"Content-Type": "application/json", "Authorization": "Bearer 4321"}
